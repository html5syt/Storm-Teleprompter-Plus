...
import { AttachmentToolbarButton } from '@/components/miaoda/tiptap-editor/components/attachment-toolbar-button';
import { BlockquoteToolbarButton } from '@/components/miaoda/tiptap-editor/components/blockquote-toolbar-button';
import { CodeBlockToolbarButton } from '@/components/miaoda/tiptap-editor/components/code-block-toolbar-button';
...
import { HorizontalRuleToolbarButton } from '@/components/miaoda/tiptap-editor/components/horizontal-rule-toolbar-button';
import { ImageUploadToolbarButton } from '@/components/miaoda/tiptap-editor/components/image-upload-toolbar-button';
...
import { UndoRedoToolbarButton } from '@/components/miaoda/tiptap-editor/components/undo-redo-toolbar-button';
...
export interface TiptapEditorCompleteProps
  extends Omit<TiptapEditorProps, 'extensions'> {
  /** 占位符文本 */
  placeholder?: string;
}
