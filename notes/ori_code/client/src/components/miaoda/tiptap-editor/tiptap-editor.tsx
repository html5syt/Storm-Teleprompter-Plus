...
import { LinkHoverToolbar } from '@/components/miaoda/tiptap-editor/components/link-hover-toolbar';
...
export function TiptapEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: cn('prose dark:prose-invert max-w-none flex-1 px-3 py-2'),
      },
    },
